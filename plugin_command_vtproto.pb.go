...
func (m *PluginCommand_UnblockCliPipeInputPayload) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *PluginCommand_UnblockCliPipeInputPayload) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	i -= len(m.UnblockCliPipeInputPayload)
	copy(dAtA[i:], m.UnblockCliPipeInputPayload)
	i = encodeVarint(dAtA, i, uint64(len(m.UnblockCliPipeInputPayload)))
	i--
	dAtA[i] = 0x2
	i--
	dAtA[i] = 0xfa
...
func (m *PluginCommand_BlockCliPipeInputPayload) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *PluginCommand_BlockCliPipeInputPayload) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	i -= len(m.BlockCliPipeInputPayload)
	copy(dAtA[i:], m.BlockCliPipeInputPayload)
	i = encodeVarint(dAtA, i, uint64(len(m.BlockCliPipeInputPayload)))
	i--
	dAtA[i] = 0x3
	i--
	dAtA[i] = 0x82
...
func (m *PluginCommand_CliPipeOutputPayload) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *PluginCommand_CliPipeOutputPayload) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.CliPipeOutputPayload != nil {
		size, err := m.CliPipeOutputPayload.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *PluginCommand_MessageToPluginPayload) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *PluginCommand_MessageToPluginPayload) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.MessageToPluginPayload != nil {
		size, err := m.MessageToPluginPayload.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *PluginCommand_KillSessionsPayload) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *PluginCommand_KillSessionsPayload) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.KillSessionsPayload != nil {
		size, err := m.KillSessionsPayload.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *PluginCommand_NewTabsWithLayoutInfoPayload) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *PluginCommand_NewTabsWithLayoutInfoPayload) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.NewTabsWithLayoutInfoPayload != nil {
		size, err := m.NewTabsWithLayoutInfoPayload.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *NewTabsWithLayoutInfoPayload) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *NewTabsWithLayoutInfoPayload) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *NewTabsWithLayoutInfoPayload) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if m.LayoutInfo != nil {
		size, err := m.LayoutInfo.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *KillSessionsPayload) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *KillSessionsPayload) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if len(m.SessionNames) > 0 {
		for iNdEx := len(m.SessionNames) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.SessionNames[iNdEx])
			copy(dAtA[i:], m.SessionNames[iNdEx])
			i = encodeVarint(dAtA, i, uint64(len(m.SessionNames[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *CliPipeOutputPayload) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *CliPipeOutputPayload) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *CliPipeOutputPayload) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if len(m.PipeName) > 0 {
		i -= len(m.PipeName)
		copy(dAtA[i:], m.PipeName)
		i = encodeVarint(dAtA, i, uint64(len(m.PipeName)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *MessageToPluginPayload) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *MessageToPluginPayload) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *MessageToPluginPayload) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if len(m.MessageArgs) > 0 {
		for iNdEx := len(m.MessageArgs) - 1; iNdEx >= 0; iNdEx-- {
			size, err := m.MessageArgs[iNdEx].MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.MessagePayload != nil {
		i -= len(*m.MessagePayload)
		copy(dAtA[i:], *m.MessagePayload)
		i = encodeVarint(dAtA, i, uint64(len(*m.MessagePayload)))
		i--
		dAtA[i] = 0x22
	}
	...
	if len(m.PluginConfig) > 0 {
		for iNdEx := len(m.PluginConfig) - 1; iNdEx >= 0; iNdEx-- {
			size, err := m.PluginConfig[iNdEx].MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *NewPluginArgs) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *NewPluginArgs) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *NewPluginArgs) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if m.PaneTitle != nil {
		i -= len(*m.PaneTitle)
		copy(dAtA[i:], *m.PaneTitle)
		i = encodeVarint(dAtA, i, uint64(len(*m.PaneTitle)))
		i--
		dAtA[i] = 0x1a
	}
	if m.PaneIdToReplace != nil {
		size, err := m.PaneIdToReplace.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *PaneId) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *PaneId) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *PaneId) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if m.PaneType != 0 {
		i = encodeVarint(dAtA, i, uint64(m.PaneType))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *OpenFilePayload) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.FloatingPaneCoordinates != nil {
		size, err := m.FloatingPaneCoordinates.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *FloatingPaneCoordinates) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *FloatingPaneCoordinates) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *FloatingPaneCoordinates) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if m.Height != nil {
		size, err := m.Height.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	if m.Width != nil {
		size, err := m.Width.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *FixedOrPercentValue) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *FixedOrPercentValue) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *FixedOrPercentValue) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *PluginCommand_UnblockCliPipeInputPayload) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	l = len(m.UnblockCliPipeInputPayload)
	n += 2 + l + sov(uint64(l))
	return n
}
func (m *PluginCommand_BlockCliPipeInputPayload) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	l = len(m.BlockCliPipeInputPayload)
	n += 2 + l + sov(uint64(l))
	return n
}
func (m *PluginCommand_CliPipeOutputPayload) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.CliPipeOutputPayload != nil {
		l = m.CliPipeOutputPayload.SizeVT()
		n += 2 + l + sov(uint64(l))
	}
	return n
}
func (m *PluginCommand_MessageToPluginPayload) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.MessageToPluginPayload != nil {
		l = m.MessageToPluginPayload.SizeVT()
		n += 2 + l + sov(uint64(l))
	}
	return n
}
func (m *PluginCommand_KillSessionsPayload) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *PluginCommand_NewTabsWithLayoutInfoPayload) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.NewTabsWithLayoutInfoPayload != nil {
		l = m.NewTabsWithLayoutInfoPayload.SizeVT()
		n += 2 + l + sov(uint64(l))
	}
	return n
}
func (m *NewTabsWithLayoutInfoPayload) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CliPipeOutputPayload) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MessageToPluginPayload) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *NewPluginArgs) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *OpenFilePayload) SizeVT() (n int) {
	...
	if m.FloatingPaneCoordinates != nil {
		l = m.FloatingPaneCoordinates.SizeVT()
		n += 1 + l + sov(uint64(l))
	}
	n += len(m.unknownFields)
	return n
...
func (m *FloatingPaneCoordinates) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *FixedOrPercentValue) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *PluginCommand) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 47:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field UnblockCliPipeInputPayload", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Payload = &PluginCommand_UnblockCliPipeInputPayload{UnblockCliPipeInputPayload: string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		case 48:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BlockCliPipeInputPayload", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Payload = &PluginCommand_BlockCliPipeInputPayload{BlockCliPipeInputPayload: string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		case 49:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CliPipeOutputPayload", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if oneof, ok := m.Payload.(*PluginCommand_CliPipeOutputPayload); ok {
				if err := oneof.CliPipeOutputPayload.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				v := &CliPipeOutputPayload{}
				if err := v.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
				m.Payload = &PluginCommand_CliPipeOutputPayload{CliPipeOutputPayload: v}
			}
			iNdEx = postIndex
		case 50:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MessageToPluginPayload", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if oneof, ok := m.Payload.(*PluginCommand_MessageToPluginPayload); ok {
				if err := oneof.MessageToPluginPayload.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				v := &MessageToPluginPayload{}
				if err := v.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
				m.Payload = &PluginCommand_MessageToPluginPayload{MessageToPluginPayload: v}
			}
			iNdEx = postIndex
		case 60:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field KillSessionsPayload", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if oneof, ok := m.Payload.(*PluginCommand_KillSessionsPayload); ok {
				if err := oneof.KillSessionsPayload.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				v := &KillSessionsPayload{}
				if err := v.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
		...
		case 62:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field NewTabsWithLayoutInfoPayload", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if oneof, ok := m.Payload.(*PluginCommand_NewTabsWithLayoutInfoPayload); ok {
				if err := oneof.NewTabsWithLayoutInfoPayload.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				v := &NewTabsWithLayoutInfoPayload{}
				if err := v.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
				m.Payload = &PluginCommand_NewTabsWithLayoutInfoPayload{NewTabsWithLayoutInfoPayload: v}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func (m *NewTabsWithLayoutInfoPayload) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: NewTabsWithLayoutInfoPayload: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: NewTabsWithLayoutInfoPayload: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LayoutInfo", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.LayoutInfo.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *KillSessionsPayload) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: KillSessionsPayload: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: KillSessionsPayload: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SessionNames", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SessionNames = append(m.SessionNames, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skip(dAtA[iNdEx:])
...
func (m *CliPipeOutputPayload) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CliPipeOutputPayload: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CliPipeOutputPayload: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *MessageToPluginPayload) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MessageToPluginPayload: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MessageToPluginPayload: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			m.PluginConfig = append(m.PluginConfig, &ContextItem{})
			if err := m.PluginConfig[len(m.PluginConfig)-1].UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MessageArgs", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.MessageArgs = append(m.MessageArgs, &ContextItem{})
			if err := m.MessageArgs[len(m.MessageArgs)-1].UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field NewPluginArgs", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.NewPluginArgs == nil {
				m.NewPluginArgs = &NewPluginArgs{}
			}
			if err := m.NewPluginArgs.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 7:
...
func (m *NewPluginArgs) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: NewPluginArgs: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: NewPluginArgs: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PaneIdToReplace", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.PaneIdToReplace == nil {
				m.PaneIdToReplace = &PaneId{}
			}
			if err := m.PaneIdToReplace.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PaneTitle", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *PaneId) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PaneId: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PaneId: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PaneType", wireType)
			}
			m.PaneType = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.PaneType |= PaneType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *OpenFilePayload) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FloatingPaneCoordinates", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.FloatingPaneCoordinates == nil {
				m.FloatingPaneCoordinates = &FloatingPaneCoordinates{}
			}
			if err := m.FloatingPaneCoordinates.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *FloatingPaneCoordinates) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FloatingPaneCoordinates: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FloatingPaneCoordinates: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			if m.X == nil {
				m.X = &FixedOrPercentValue{}
			}
			if err := m.X.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
		...
		case 3:
			...
			if m.Width == nil {
				m.Width = &FixedOrPercentValue{}
			}
			if err := m.Width.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
			...
			if m.Height == nil {
				m.Height = &FixedOrPercentValue{}
			}
			if err := m.Height.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *FixedOrPercentValue) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FixedOrPercentValue: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FixedOrPercentValue: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Type |= FixedOrPercent(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
